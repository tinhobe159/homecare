...
const CaregiverCard = ({ caregiver, skills, caregiverSkills }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 p-6 border border-gray-200">
      <div className="flex items-center mb-4">
        ...
        <div>
          ...
          <div className="flex items-center space-x-2 mt-1">
            ...
            <span className="text-sm text-gray-500">{caregiver.years_experience || 'N/A'} years experience</span>
          </div>
      ...
      <p className="text-gray-600 text-sm mb-4 line-clamp-3">{caregiver.bio || 'No bio available'}</p>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-1">
          ...
          <span className="text-sm font-medium text-gray-900">{caregiver.rating || 'N/A'}</span>
          <span className="text-sm text-gray-500">({caregiver.total_reviews || 0} reviews)</span>
        </div>
