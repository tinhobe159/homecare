...
import { 
  Plus, Edit, Trash2, Search, Shield, 
...
const AdminRoles = () => {
  ...
  const calculateMetrics = () => {
    ...
    const totalUsers = Object.values(roleUserCounts).reduce((sum, count) => sum + count, 0);
    const averageUsers = total > 0 ? totalUsers / total : 0;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="text-gray-500">Role Management</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-purple-600 mt-1">With roles assigned</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Avg Users</p>
                <p className="text-2xl font-bold text-gray-900 mt-2">{metrics.averageUsers.toFixed(1)}</p>
                <p className="text-sm text-orange-600 mt-1">Per role</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredRoles.map((role) => (
            <div key={role.id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
              <div className="p-6">
                {/* Header */}
        ...
        {filteredRoles.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-xl text-gray-500 mb-2">No roles found</p>
